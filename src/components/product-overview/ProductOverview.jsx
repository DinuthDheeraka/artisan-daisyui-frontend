...
import ProductOverviewLoadingSkeleton from "../product-overview-loading-skeleton/ProductOverviewLoadingSkeleton.jsx";
...
export default function ProductOverview({id}) {
    ...
    return (
        isLoading ? <div className="mt-16 flex flex-row container mx-auto justify-items-start mb-36 justify-start">
                <ProductOverviewLoadingSkeleton/>
            </div> :
                ...
                <div className='w-1/2 flex flex-col items-start justify-start px-5 gap-6' style={{height: '660px'}}>
                    ...
                    <div className='flex flex-row gap-1'>
                        ...
                        <p className='font-light'>
                            {product.qty === 0 ? 'No items left' : `Only ${product.qty} left`}
                        </p>
                    </div>
                    ...
                    <div className="w-72 h-60 mt-10">
                        <button onClick={() => {
                            if (product.qty === 0) {
                                ...
                                MySwal.fire({
                                    title: <p className={'text-lg text-black'}>Oops, looks like product just sold
                                        out!</p>,
                                    // eslint-disable-next-line react/no-unescaped-entities
                                    html: <p className={'text-base font-medium text-black'}>Let's try something else!</p>,
                                    icon: 'info',
                                ...
                                MySwal.fire({
                                    title: <p className={'text-xl text-black'}>Do you want to add this item to the
                                        cart!</p>,
